...
namespace Enterprises.Framework.Utility
{
    ...
    {
        //浏览器列表
        private static readonly string[] Browserlist = new[] { "ie", "chrome", "mozilla", "netscape", "firefox", "opera", "konqueror" };
        //搜索引擎列表
        private static readonly string[] Searchenginelist = new[] { "baidu", "google", "360", "sogou", "bing", "msn", "sohu", "soso", "sina", "163", "yahoo", "jikeu" };
        //meta正则表达式
        private static readonly Regex Metaregex = new Regex("<meta([^<]*)charset=([^<]*)[\"']", RegexOptions.IgnoreCase | RegexOptions.Multiline);
        ...
        {
            var cookie = new HttpCookie(name) {Expires = DateTime.Now.AddYears(-1)};
        ...
        public static AspNetHostingPermissionLevel GetTrustLevel()
        {
            ...
            //权限列表
            var levelList = new AspNetHostingPermissionLevel[] {
